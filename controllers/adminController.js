...
exports.getHomePageContentAdmin = async (req, res) => {
    try {
        ...
        // Convert array to a more accessible object for the view
...
exports.updateHomePageContent = async (req, res) => {
    try {
        // 1. Update all text fields from req.body
        ...
        // 2. Handle file uploads from req.files
        if (req.files) {
            for (const [fieldName, fileArray] of Object.entries(req.files)) {
                if (fileArray && fileArray.length > 0) {
                    ...
                    // Find the old image path to delete it
...
exports.deleteProject = async (req, res) => {
    try {
        const project = await Project.findById(req.params.id);
        if (project && project.coverImage !== '/images/default.jpg') {
